...
CREATE TABLE IF NOT EXISTS `ModnaRevija`.`Angazuje` (
  `Dizajner_Ucesnici_jmbg` INT NOT NULL,
  `Pomocno osoblje_Ucesnici_jmbg` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ModnaRevija`.`Sredjuje` (
  `Angazuje_Dizajner_Ucesnici_jmbg` INT NOT NULL,
  `Angazuje_Pomocno osoblje_Ucesnici_jmbg` INT NOT NULL,
  `Model_Ucesnici_jmbg` INT NOT NULL,
