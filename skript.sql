...
CREATE TABLE IF NOT EXISTS `ModnaRevija`.`Sredjuje` (
  ...
  PRIMARY KEY (`Model_Ucesnici_jmbg`, `Pomocno osoblje_Ucesnici_jmbg`),
  INDEX `fk_Sredjuje_Pomocno osoblje1_idx` (`Pomocno osoblje_Ucesnici_jmbg` ASC),
  CONSTRAINT `fk_Sredjuje_Model1`
    FOREIGN KEY (`Model_Ucesnici_jmbg`)
    REFERENCES `ModnaRevija`.`Model` (`Ucesnici_jmbg`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_Sredjuje_Pomocno osoblje1`
